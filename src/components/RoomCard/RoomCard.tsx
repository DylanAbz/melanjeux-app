...
interface RoomCardProps {
    ...
    subtitle: string;
    location: string;
    roomId: string; // Add roomId for navigation
}

const DEFAULT_IMAGE = '/public/booking.svg'; // Using an existing image as default for demonstration

const RoomCard: React.FC<RoomCardProps> = ({ imageUrl, title, subtitle, location, roomId }) => {
    ...
    return (
        <div className="room-card" style={backgroundStyle} onClick={handleCardClick}>
